...
namespace ILRepacking
{
    internal class ReferenceFixator
    {
        ...
        private InterfaceImplementation Fix(InterfaceImplementation type)
        {
            ...
            return new InterfaceImplementation(Fix(type.InterfaceType));
        }
            ...
            if (debugInformation.HasCustomDebugInformations)
            {
                foreach (var customDebugInformation in debugInformation.CustomDebugInformations)
                {
                    if (customDebugInformation is AsyncMethodBodyDebugInformation)
                    {
                        ...
                        if (asyncDebugInformation.MoveNextMethod != null)
                        {
                            asyncDebugInformation.MoveNextMethod = (MethodDefinition)Fix(asyncDebugInformation.MoveNextMethod, true);
                        }
                    }
